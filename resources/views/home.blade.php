<x-layout>
  <div class="flex space-x-4 mb-8 uppercase">
    ...
    <a href="/?topRatingCompany=top & {{ http_build_query(request()->except('topRatingCompany', 'page')) }}" class="@if(request('topRatingCompany')) pb-2 border-b-4 border-cyan-500 @else pb-2 border-b-4 border-gray-300 @endif">Comms with top rated companies</a>
  </div>
